...
public class StoreController {
    ...
    @PostMapping(path = "/createProduct", consumes = "application/x-www-form-urlencoded")
    String createProduct(ProductEntity product) {
        ...
        String output = "<form action='' method='POST'>";
        output += product.getName() + " has been added to the database successfully. <br />";
        output += product.getName() + " costs: $" + product.getPrice() + "<br />";
        output += "<input type ='submit' />";
        output += "</form>";
        return output;
    }
